...
[From Static to Dynamic Views]{.blue}

Early criminology relied on [snapshots of offenders]{.orange}, but social reaction theories showed that [behavior and identity change over time]{.blue2}

<br>

[Rise of Longitudinal Research]{.blue}

[Birth cohort studies]{.orange} in the 1970s–1980s allowed scholars to track individuals across years, revealing patterns of onset, persistence, and desistance

<br>

[Criminal Career Perspective]{.blue}

Blumstein’s work shifted the field toward studying offending as a career — with measurable elements like [frequency (λ), duration, and desistance]{.orange}

<br>

[Modern Developmental/Life-Course Theories]{.blue}

These foundations led to today’s focus on [trajectories and transitions]{.orange}, emphasizing how life events and age-graded processes shape offending over time
...
Explanatory models that track individuals across the life course, focusing on how and why offending begins, persists, and eventually declines.
...
![](Images3/trag.jpg){.absolute top=370 left=0 height="40%"}
:::
...
![](Images3/transition.jpg){.absolute top=370 right=150 height="30%"}
...
[Frequency]{.blue} (λ) - [The rate]{.blue} at which an individual offends 
...
Argue that self-control is [largely stable by about age 8–10 and remains relatively unchanged throughout adulthood]{.blue2}
...
Used ["life-event calendar"]{.blue} to measure change from [month to month]{.orange} over three years 
...
Which [turning points]{.orange} — a first serious breakup, landing (or losing) a well-paid job, graduating into a recession vs. a boom - or a major “knifing-off” moment in the Laub & Sampson sense, [do you predict would bend those trajectories the most?]{.blue2}
...
[A reciprocal developmental model where weak social bonds and delinquency mutually reinforce each other]{.orange}

<br>

[Reciprocal]{.blue}

A [two-way causal process]{.blue2} in which variables influence each other simultaneously, creating a [feedback loop]{.blue2} rather than a one-directional effect
...
Step 3️⃣ Delinquency Occurs and [Loop Emerges]{.blue} 
...
[Same room on Tuesday December 16th, same room, 1 PM]{.blue}
...
## A Sylvia Plath Poem
![](Images/figtree.png){fig-align="center"}

::: footer

The Fig Tree from [the Bell Jar](https://en.wikipedia.org/wiki/The_Bell_Jar)
