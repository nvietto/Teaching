...
Early [positivist ideals, especially determinism,]{.violet} led to problematic biological and psychological deterministic explanations and policies (e.g., eugenics, racial profiling, and the 'born criminal' myth)

<br>

As a result, the field pulled back from individual-level explanations and shifted toward [social and structural causes]{.blue} of crime
...
Elaborate we are not discussion modern biological or psychological theories which are probabilistic
...
Although, *positivism introduced the use of the scientific method*, which allowed [systematic observation, measurement, and analysis]{.blue2}

<br>

Comte and Quetelet (we will discuss next) built on this idea, [moving away from biological determinism and applying scientific principles to understand the social and structural causes of crime]{.orange}

<br>


This shift marked the birth of modern [social science]{.blue}, [systematic study of human behavior, society, and social relationships using methods of observation, measurement, and analysis]{.blue2}
...
Founder of Sociology, introduced the idea that society can be studied scientifically.
...
[**Social Statics:**]{.blue} Study of *social order and stability*, how institutions, norms, and hierarchies maintain cohesion)

<br>

[**Social Dynamics:**]{.blue} Study of *social change and progress*, how societies evolve and adapt over time

Large-scale social change disrupting existing structures.
...
Comte was a French philosopher often regarded as the founder of sociology and the originator of positivism, the idea that social life can be studied using the same scientific methods as the natural sciences.
...
[Occupy Wall Street (2011)]{.blue}

<br>

Grassroots movement protesting economic inequality, corporate power, and political imbalance

<br>

Began in Zuccotti Park (and later Union Square) in New York City, then spread nationally and globally (e.g., London, Madrid, Hong Kong)

<br>

Sparked major discussion on income inequality, student debt, and corporate influence

<br>

Inspired later activism in climate justice, housing, and economic reform
...
![](Images/occupy.png){fig-align="center"}
:::
:::
...
**Relative deprivation** refers to the **perception that one is worse off compared to others or to an expected standard**, even if their absolute living conditions are adequate.


Essense of idea:

People may compare themselves to peers, neighbors, or reference groups, and when they feel deprived relative to those groups, it can create a sense of injustice. This perceived inequality can foster anger, strain, or alienation—conditions that theories like strain theory and subcultural theories link to higher risks of crime, protest, or antisocial conduct.
...
Individuals in economically disadvantaged neighborhoods who see others around them enjoying wealth or success may experience relative deprivation, which can increase motivation to engage in theft, fraud, or other forms of crime to “close the gap.”

:::

## Recap 

Positivism to a purely sociological explanation of crime and related acts
...
French sociologist (1858–1917), often referred to as the most influential sociologist to ever live. Due to him [transforming sociology into an empirical science]{.blue}

<br>

Emphasized empirical research and the [importance of objective data (e.g., statistics) in studying social phenomena]{.orange}

<br>

His concepts (e.g., anomie) remain central to sociological theory, [informing research on social integration, norms, and collective behavior]{.blue2}
...
## Anomie at the Individual Level

:::{.smaller-text}

<br>

1️⃣ Durkheim extended the concept of anomie to explain [how large-scale social changes can shape individual behavior]{.blue}

<br>

2️⃣ [When norms weaken]{.blue2}, individuals experience less guidance and connection to the collective moral order.

<br>

3️⃣ This [loss of regulation and integration]{.blue} can lead to feelings of isolation, purposelessness, and despair.

<br>

Durkheim argued that suicide rates reflect levels of social integration and regulation - not just personal or psychological factors.
...
[Durkheim’s Anomie:]{style="text-decoration: underline;"} 

Rapid Social Change ➡️ Breakdown of Norms ➡️ [Anomie]{.blue}

<br>

[Anomie]{.blue} (i.e., “normlessness” – society fails to regulate goals/behavior)

<br>

Anomie ➡️ Decrease in the [Collective Conscious]{.orange} 

**[Collective Conscious]{.orange} refers to the shared beliefs, values, norms, and moral attitudes that unify individuals within a society, acting as a social glue and shaping behavior**

<br>

[Durkheim’s Insight:]{style="text-decoration: underline;"}

[Broader social structures, not just personal factors, shape behavior and stability within society]{.blue2}
...
Anomie is the structural strain itself - [the imbalance between society’s emphasis on cultural goals (wealth, success) and the lack of access to legitimate institutionalized means (education, jobs) to achieve them]{.blue2}, which [leads to deviance]{.orange}
...
1️⃣ [Cultural Goals:]{.blue} Societal aspirations (e.g., wealth, success)

<br>

2️⃣ [Institutionalized Means:]{.blue} Legitimate paths to achieve goals (e.g., education, hard work)

<br>

3️⃣ [Strain:]{.orange} Disconnect between cultural goals and access to institutionalized means

<br>

4️⃣ [Anomie:]{.blue} Normlessness due to societal pressure/breakdown which [leads to deviance]{.blue2}
...
These [adaptations]{.blue} reflect [responses to the strain between society’s emphasis on success (goals) and unequal access to legitimate opportunities (means)]{.blue2}

<br>

1️⃣ [Conformity:]{.blue} Accepts both societal goals and legitimate means (e.g., pursuing wealth through education/hard work)

2️⃣ [Innovation:]{.blue} Accepts cultural goals but uses illegitimate means to achieve them (e.g., theft, fraud)

3️⃣ [Ritualism:]{.blue} Abandons cultural goals but rigidly follows institutionalized means (e.g., bureaucratic workers “going through the motions”)

4️⃣ [Retreatism:]{.blue} Rejects both goals and means, withdrawing from society (e.g., substance abuse, homelessness)

5️⃣ [Rebellion:]{.blue} Rejects societal goals and means, replacing them with new ones (e.g., revolutionaries seeking to overthrow systems)
...
[Key Shift from Merton:]{style="text-decoration: underline;"} 
