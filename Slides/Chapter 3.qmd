...
# But First... some important concepts

## Criteria for Determining Causality

::: {.smallest-text}

[Causality]{.violet} refers to the idea that one event or factor directly produces a change in another, rather than simply being associated with it. 

Ex.) Weak attachment (social bonds) to parents (cause) can lead to higher involvement in delinquency (effect), illustrating a causal link between family bonds and crime.


<br>

1️⃣ [Temporal Ordering]{.blue}

[**X (predictor)** must occur before **Y (outcome)**]{.green} to establish a cause-effect relationship.

2️⃣ [Correlation]{.blue}
...
3️⃣ [Controlling for Spuriousness]{.blue}
...
Swiftness + Certainty + Severity ➡️ Deterrence
...
set the landscape. Use an intersection or somehting for the palce 
...
Walk through your routine for an example
...
[Here](https://create.kahoot.it/details/e4a3af45-8622-43c2-ab3c-030660a745c2)
