...
And 9 will only really focus on Marx theory, which we will cover on Tuesday, but only a tad bit. Not too much before the exam
...
Attitudes and values either favorable or unfavorable to law

**The four moderators:**

intensity (e.g., romantic relationships)

duration (e.g., life long friend)

frequency ( often associated )
...
Individuals [learn to either continue or discontinue behaviors based on the rewards or punishments they experience]{.blue}

<br> 

Social environment provides definitions and [reinforcements]{.blue2} that can encourage or discourage criminal behavior (e.g., peer approval vs. disapproval)

<br> 

Social environment adds [positive]{.green} or [negative]{.red} stimulus to criminal behavior
...
[Positive Reinforcement]{.blue}: Presenting a desirable stimulus after a behavior (increases likelihood of the behavior)

[Negative Reinforcement]{.blue2}: Removing an unpleasant stimulus when the behavior occurs (also increases likelihood of the behavior)

[Punishment:]{.aqua} Applying an unpleasant consequence or removing a pleasant one (decreases likelihood of the behavior)
...
After stealing a valuable item, the thief **gains money or a personal benefit**.  
This pleasant outcome (e.g., extra cash) reinforces the stealing behavior.  

**Positive Punishment (adding an unpleasant stimulus):**   
The thief is caught and immediately **fined or sent to jail**.  
This added consequence (the fine or incarceration) punishes the stealing behavior.   

**Negative Reinforcement (removing an unpleasant stimulus):**  
The thief steals food to avoid hunger. The **removal of discomfort (hunger) reinforces** the stealing.   

**Negative Punishment (removing a desirable stimulus):**   
Upon getting caught, the thief loses privileges (e.g., loss of a driver’s license or restricted freedom).
**The removal of these privileges punishes the stealing behavior.**  
...
While they generally accept mainstream moral values, they use [justifications or 'techniques of neutralization']{.blue} to [temporarily suspend or neutralize these values]{.blue2} when engaging in delinquency
...
If the instant gratification of likes on platforms like TikTok reinforces or normalizes deviant behaviors among viewers, [what platform-level strategies or features could be introduced to discourage such conduct without significantly reducing user engagement?]{.blue} 

<br>

For example, content warnings and rating labels were added to films in the 1970s to guide audiences, which parallels to this idea. 
...
Carl Sagon annocement 

**Ad hom example:**

"You can't believe anything he says; he's just a student."

(Attacking the person's status instead of the argument) 

"You can't trust her opinion on climate change; she's a known liar." (Attacking the person's character instead of the argument about climate change)

**Straw man example:**

Person A: "I think we should have more regulations on the fishing industry to protect endangered species."
Person B: "So, you want to shut down the entire fishing industry and put everyone out of work?"

(Person B misrepresents Person A's argument by implying an extreme and unrealistic outcome). 

Person A: "I think we should have more funding for public education."   

Person B: "So, you want to take all the money from private schools and give it to public schools?"  
...
Characterized by impulsivity, preference for simple tasks, risk-seeking, and insensitivity to others
...
After your experience with extended remote learning during COVID, [were your peers (or yours) attachments to school values and community permanently changed?]{.blue} Consider the absence of in-person classes, casual hallway interactions, sports events, prom etc... 

[Did you notice any changes peer behavior that would align with Hirchi's Social Bonding Theory?]{.blue2}

<br>

[Have these effects persisted into college or disappeared once traditional, face-to-face classes resume?]{.aqua}

<br>

Make an argument for your choice. Elect one speaker to present your point.
