...
[A characteristic that describes people, objects, or places and takes on [multiple]{.grey} values in a sample or a population]{style="color:#859ab2;"}.
...
[A characteristic that describes people, objects, or places and takes on [only one]{.grey} value in a sample or a population]{style="color:#859ab2;"}.
